...
const SEKMELER = [
  { href: "/admin/raporlar", label: "Kullanıcılar", exact: true },
  { href: "/admin/raporlar/izlenmeler", label: "İzlenmeler", exact: false },
  { href: "/admin/raporlar/odemeler", label: "Ödemeler", exact: false },
];

// Ayarlar bölümündeki AyarlarSekmeleri ile aynı desen — Raporlar'ın üç alt
// sayfası arasında ince, sağa yaslı bir şeritle geçiş.
