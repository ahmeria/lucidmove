...
// Dosya seçilince önce GorselKirpici modalı açılır (bkz. o dosya).
export default function GorselKutusu({
  ...
  return (
    <>
      ...
      {seciliDosya && (
        <GorselKirpici dosya={seciliDosya} oran={oran} onTamam={kirpmaTamamlandi} onIptal={() => setSeciliDosya(null)} />
      )}
    </>
  );
}
